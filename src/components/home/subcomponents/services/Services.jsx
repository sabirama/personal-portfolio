...
const Services = () => {
  ...
  return (
    <section id="services" className="section">
      ...
      <div className="container mt-1 col">
        {val === 1 ? (
          <>
            <h4>Front End Development</h4>
            <div>
              <p>
                Using Figma, HTML5, CSS3 and Javascrpit, I can create a static website for clients based on given Design
                or create it all from scratch.
              </p>
              <p>
                Or, use React.js along with Vite.js Node.js for more better website performance and faster development.
              </p>
            </div>
          </>
        ) : val === 2 ? (
